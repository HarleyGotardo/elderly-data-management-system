...
exports.down = function() {
  ...
  // Remove sync columns from senior_citizens (one by one for SQLite)
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN lgu_id`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN sync_version`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN sync_status`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN last_synced_at`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN sync_error`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN admin_notes`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN admin_decision_at`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN export_batch_id`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN import_batch_id`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN is_readonly`);
  db.exec(`ALTER TABLE senior_citizens DROP COLUMN payment_status`);
